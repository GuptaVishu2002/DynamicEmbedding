...
def main(
    ...
    **kwargs,
    ...
    dataset = CompositionData(data_path=data_path, fea_path=fea_path, task=task, fea_num=fea_num)
    ...
    if evaluate:
        if test_path:
            ...
            test_set = CompositionData(
                data_path=test_path, fea_path=fea_path, task=task, fea_num=fea_num
            )
    ...
    if train:
        if val_path:
            ...
            val_set = CompositionData(data_path=val_path, fea_path=fea_path, task=task, fea_num=fea_num)
...
def input_parser():
    ...
    parser.add_argument(
        "--data-path",
        type=str,
        default="../../matminer/oqmd_cvsplit_roost/oqmd_cvsplit_roost_train_123456789.csv",
        metavar="PATH",
    ...
    valid_group.add_argument(
        "--val-path",
        type=str,
        default="../../matminer/oqmd_cvsplit_roost/oqmd_cvsplit_roost_set_10.csv",
        metavar="PATH",
    ...
    test_group.add_argument(
        "--test-path",
        type=str,
        default="../../matminer/oqmd_cvsplit_roost/oqmd_cvsplit_roost_test_set.csv",
        metavar="PATH",
    ...
    parser.add_argument(
        ...
        default=9,
        metavar="INT",
        help="Element embedding feature number",
    )
