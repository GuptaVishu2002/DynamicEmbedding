...
def input_parser():
    ...
    parser.add_argument(
        "--data-path",
        type=str,
        default="../../../matminer/dataset/oqmd_roost/oqmd_cgcnn_deltae_training.csv",
        metavar="PATH",
    ...
    valid_group.add_argument(
        "--val-path",
        type=str,
        default="../../../matminer/dataset/oqmd_roost/oqmd_cgcnn_deltae_val.csv",
        metavar="PATH",
    ...
    test_group.add_argument(
        "--test-path",
        type=str,
        default="../../../matminer/dataset/oqmd_roost/oqmd_cgcnn_deltae_test.csv",
        metavar="PATH",
